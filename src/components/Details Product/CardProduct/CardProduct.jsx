...
const CardProduct = ({ product, stock }) => {
    ...
    let buyMade = () => {
        Swal.fire({
            ...
            if (result.isConfirmed && stockActual >= 1) {
                Swal.fire(`Compraste!!! `, `${product.title}`, "success");
                setStock(stockActual -= 1)
            } else {
                Swal.fire(`No hay stock, intentalo más tarde!!! `, `${product.title}`, "error");
                setStock(stockActual -= 1)
            }
        });
    }
                        ...
                        <div className="right-side-pro-detail border p-3 m-0 card-details">
                            <div className="row">
                                ...
                                <div className="col-lg-12 d-flex align-items-center">
                                    ...
                                    <input type="number" min="1" max="99" maxlength="2" value={stockActual} class="form-control text-center w-25 ml-4"></input>
                                </div>
